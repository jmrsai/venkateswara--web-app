...
## GetSevasList
You can execute the `GetSevasList` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetSevasListData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getSevasList } from '@dataconnect/generated';
...
import { connectorConfig, getSevasListRef } from '@dataconnect/generated';
...
## GetTempleInsights
You can execute the `GetTempleInsights` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetTempleInsightsData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getTempleInsights } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getTempleInsightsRef } from '@dataconnect/generated';
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getMyBookings, GetMyBookingsVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getMyBookingsRef, GetMyBookingsVariables } from '@dataconnect/generated';
...
## GetGallery
You can execute the `GetGallery` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetGalleryData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getGallery } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getGalleryRef } from '@dataconnect/generated';
...
## GetDigitalLibrary
You can execute the `GetDigitalLibrary` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetDigitalLibraryData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getDigitalLibrary, GetDigitalLibraryVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getDigitalLibraryRef, GetDigitalLibraryVariables } from '@dataconnect/generated';
...
## GetUpcomingEvents
You can execute the `GetUpcomingEvents` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetUpcomingEventsData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getUpcomingEvents } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getUpcomingEventsRef } from '@dataconnect/generated';
...
## GetLatestNews
You can execute the `GetLatestNews` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetLatestNewsData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getLatestNews } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getLatestNewsRef } from '@dataconnect/generated';
...
## GetPanchangam
You can execute the `GetPanchangam` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetPanchangamData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getPanchangam, GetPanchangamVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getPanchangamRef, GetPanchangamVariables } from '@dataconnect/generated';
...
## GetMyDonations
You can execute the `GetMyDonations` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetMyDonationsData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getMyDonations, GetMyDonationsVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getMyDonationsRef, GetMyDonationsVariables } from '@dataconnect/generated';
...
## UpdateInsights
You can execute the `UpdateInsights` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `UpdateInsightsData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, updateInsights, UpdateInsightsVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, updateInsightsRef, UpdateInsightsVariables } from '@dataconnect/generated';
...
## SubmitFeedback
You can execute the `SubmitFeedback` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `SubmitFeedbackData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, submitFeedback, SubmitFeedbackVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, submitFeedbackRef, SubmitFeedbackVariables } from '@dataconnect/generated';
